...
def custom_admin_detail_keyboard(custom_id: str) -> InlineKeyboardMarkup:
    keyboard = [
        [InlineKeyboardButton(text="✏️ ویرایش", callback_data=f"acustom:edit:{custom_id}")],
        [InlineKeyboardButton(text="👥 بازیکنان", callback_data=f"acustom:players:{custom_id}")],
        [
